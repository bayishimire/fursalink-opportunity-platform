...
export default function StudentDashboard() {
  ...
  return (
    <Box maxW="1200px" mx="auto" pb={20}>
      ...
      <Card.Root rounded="3xl" shadow="md" border="none" bg="white" mb={12}>
        <Card.Body p={8}>
          <Flex justify="space-between" align="center" flexWrap="wrap" gap={6}>
            <HStack gap={6}>
              <Avatar.Root size="2xl" border="4px solid" borderColor="blue.50">
        ...
        <Card.Body p={2}>
          <HStack gap={2} w="full">
            <Box flex={1} position="relative">
              ...
              <Input placeholder="Search modules, lessons, instructors..." variant="plain" border="none" _focus={{ ring: 'none' }} h="40px" pl={10} fontSize="xs" fontWeight="bold" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
            </Box>
      ...
      <Box>
        {isLoading ? (
          <Center py={20}><Spinner size="xl" color="blue.500" thickness="4px" /></Center>
        ) : courses.length > 0 ? (
